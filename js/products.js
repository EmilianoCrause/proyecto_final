...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    // Listeners móvil
    document.getElementById("rangeFilterPriceMobile").addEventListener("click", () => filtrarPorPrecio("rangeFilterPriceMinMobile", "rangeFilterPriceMaxMobile"));
    document.getElementById("clearRangeFilterMobile").addEventListener("click", () => limpiarFiltros("rangeFilterPriceMinMobile", "rangeFilterPriceMaxMobile"));

    document.getElementById("sortAscMobile").addEventListener("click", () => ordenarProductos("priceAsc"));
    document.getElementById("sortDescMobile").addEventListener("click", () => ordenarProductos("priceDesc"));
    document.getElementById("sortByCountMobile").addEventListener("click", () => ordenarProductos("relevance"));
});
